...
r{2} = [(q(2)+d(2))*cos(q(1)); (q(2)+d(2))*sin(q(1)); 0];
gravity = [0; 0; -g0];
...
[vcm, rcm0, Tcm, M, c, christoff, S, Ucm, g] = ...
    subs_all(l(1), 0, vcm, rcm0, Tcm, M, c, christoff, S, Ucm, g);

[vcm, rcm0, Tcm, M, c, christoff, S, Ucm, g] = ...
    subs_all(d(1), 0, vcm, rcm0, Tcm, M, c, christoff, S, Ucm, g);

[vcm, rcm0, Tcm, M, c, christoff, S, Ucm, g] = ...
    subs_all(m(1), 0, vcm, rcm0, Tcm, M, c, christoff, S, Ucm, g);
