%%  RPR planar robot - Dynamics
%   @Giuseppe Sensolini, April 2020
...
r{2} = [q(2)*cos(q(1)+pi/2); q(2)*sin(q(1)+pi/2); 0];
r{3} = [l(3)*cos(q(3)+q(1)+pi/2); l(3)*sin(q(3)+q(1)+pi/2); 0];
% #######################

disp("=== MOVING FRAME ALGO ===============================================");
[vcm, w, rcm0] = moving_frame_algo_v2(q, dq, r, l, d, sigma);
